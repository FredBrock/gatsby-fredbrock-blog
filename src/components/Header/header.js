...
import cssnames from "classnames"
    ...
    <header>
      <div className="nav relative z-50">
        <div className="nav-container  flex justify-between">
          <a href="#" className="nav-logo text-xl font-bold">
            Fredbrock
          </a>
          ...
          <button
            type="button"
            onClick={buttonClick}
            className={cssnames("mobile-menu", "outline-none", "lg:hidden", {
              active: isExpand,
            })}
          >
